...
import { Component, type PropsWithChildren, useEffect, useRef } from 'react';
...
class InspectorErrorBoundary extends Component<PropsWithChildren> {
...
const Inspector = /* @__PURE__ */ constant(() => {
  ...
  const containerClassName = useSignalValue(inspectorContainerClassName);
