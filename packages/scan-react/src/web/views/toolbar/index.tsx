...
export const Toolbar = constant(() => {
  ...
  const widgetView = useSignalValue(signalWidgetViews);
  const isPaused = useComputed(
    () => !!ReactScanInternals.instrumentation?.isPaused.value,
  );
  const showFPS = useComputed(
      ...
      <div className="h-full flex items-center justify-center">
        ...
        >
          <Notification
            ...
            className={cn([
              'text-[#999]',
              widgetView.view === 'notifications' && 'text-[#8E61E3]',
            ])}
          />
        </button>
      </div>
